...
Polyphony is achieved through 4 identical oscillators each playing a separate note. The outputs of the oscillators are pre-scaled according to the number of notes currently played, to avoid saturation and distortion. Then the samples are added together, achieving polyphony.
